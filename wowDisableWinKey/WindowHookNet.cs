...
namespace WindowHookNet
{
    ...
    public class WindowHookNet
    {
        ...
        private bool EnumWindowsProc(IntPtr hWnd, int lParam)
        {
            ...
            //tArgument.ProcessName = GetProcessName(hWnd);
           // tArgument.Process = GetProcess(hWnd);
        ...
        #region GetWindowText/ClassName/ProcessId
        /// <summary>
        ...
        public static System.Diagnostics.Process GetProcess(IntPtr hWnd)
        {
            uint processId;
            wowDisableWinKey.Interop.GetWindowThreadProcessId(hWnd, out processId);
